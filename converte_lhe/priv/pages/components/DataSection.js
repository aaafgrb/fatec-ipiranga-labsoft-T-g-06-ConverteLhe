...
export default {
  ...
  inject: ['getComposition', 'getCompShare'],
  mounted(){
  ...
  <form id="inForm" ref="inForm">
    <div class="row g-0">
      <button class="btn btn-secondary col-1" type="button" @click="userButton()">
      ...
      <button class="btn btn-secondary col-1" type="button" @click="shareButton">
